...
ML Security Engineer · IEEE INDICON 2023 Author · AWS Cloud Security · M.S. Information Technology (Security), Arizona State University
...
I work at the intersection of **machine learning** and **security** — building ML systems that detect anomalies, protect data, and run reliably in production. My projects span satellite telemetry, industrial predictive maintenance, GPU infrastructure, and carbon analytics.
...
- **IEEE INDICON 2023** — Author & Presenter (Personalized E-Learning with Reinforcement Learning)
- **Honeywell Aerospace × ASU** — Technology Innovation Lab
- **AWS** — Cloud Security Foundations, Cloud Architecting

---

## Tech

**ML & Security:** Python, PyTorch, scikit-learn, FastAPI, JWT/RBAC, AES encryption, anomaly detection  
**Infrastructure:** Docker, GitHub Actions CI/CD, Prometheus, Grafana, Kafka, MQTT  
**Data:** PostgreSQL, Firebase, NASA C-MAPSS, time-series processing  
**Domains:** Predictive maintenance, satellite telemetry, GPU memory management, carbon analytics
