...
| **[hf-model-provenance-scanner](https://github.com/poojakira/hf-model-provenance-scanner)** | Scans model repos for pickle-risk, provenance, and impersonation; maps findings to MITRE ATT&amp;CK. | Fixture-scoped evidence; not a real-world detection rate. |
...
Findings map to **MITRE ATT&amp;CK / ATLAS** and **NIST AI RMF** where the repositories support it.
