...
<!-- Animated hero hook -->
<a href="https://poojakira.github.io/ai-security-portfolio/">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&pause=1000&color=4FD1C5&center=true&vCenter=true&width=820&lines=AI+stops+being+a+prediction+problem...;...and+becomes+a+security+problem+the+moment+it+can+ACT.;Capability+is+not+permission.;Permission+is+not+provenance.;Identity+is+not+authorization." alt="Typing hook" />
</a>
...
<p>
  <img src="https://img.shields.io/badge/Focus-Agentic_AI_Security-4FD1C5?style=for-the-badge" />
...
### 🤖 Meet my interactive AI Security portfolio — ask it, or talk to it, about my work

<a href="https://poojakira.github.io/ai-security-portfolio/">
  <img src="https://img.shields.io/badge/▶_LAUNCH_THE_INTERACTIVE_PORTFOLIO-4FD1C5?style=for-the-badge&logo=probot&logoColor=black" alt="Launch the interactive AI security portfolio" />
</a>

<sub>A grounded, keyless, client-side assistant trained on my verified work — ask about my projects, engineering decisions, or metrics. Every answer links to the source. It also talks: press once and ask out loud.</sub>
...
> ⚠️ *These are research & portfolio projects: functional, tested, and open-source — but not hardened for enterprise scale. Every claim I publish states the scope it holds within.*
...
Inline gateway between an MCP client and downstream server. Inspects `tools/call` requests over **JSON-RPC** *before* execution and makes **allow/block** decisions across five layers.

**Detects:** prompt injection · PII leakage · shadow servers · exfiltration patterns
**Adds:** hash-chained audit log · rate limiting · circuit breaker (fails closed)

> *569 tests · 75% coverage · ~51% detection on the bundled attack catalog (a scoped number, not a general rate).*
...
Pre-load **supply-chain scanner** for Hugging Face repos. Catches **pickle exploits, typosquatting, and obfuscated payloads** by inspecting file headers — *without downloading model weights*. Findings map to **MITRE ATT&CK v19**.

**Bonus:** runtime `torch.load()` interception hook.

> *Ships a LIMITATIONS.md that says exactly which claims it will not make.*
...
> *Deliberately narrower than Prowler or IAM Access Analyzer — and says so.*
...
|---|---|:---:|
| [llm-redteam-framework](https://github.com/poojakira/llm-redteam-framework) | Offline prompt-injection detector eval. Grouped-split **F1 0.97** (held-out templates), 1.0 on the easy random split — the gap is the point. | `Beta` |
...
| [model-privacy-attacks](https://github.com/poojakira/model-privacy-attacks) | Membership-inference on real UCI Adult data (MIA AUC 0.499→0.625 as a model overfits) | `Research` |
| [dataset-poisoning-detector](https://github.com/poojakira/dataset-poisoning-detector) | Statistical poisoning screening — reports **AUC 0.53–0.56** (near chance) honestly | `Beta` |

## 🧱 Shared Libraries & Supporting Work

| Repository | What it does | Status |
|---|---|:---:|
| [attack-v19-core](https://github.com/poojakira/attack-v19-core) | MITRE ATT&CK v19 data models & technique lookup for Python (222 techniques, 475 sub-techniques) | `Beta` |
...
- 🎓 **MS, Information Technology** — Arizona State University (expected 2026) · 3.87 GPA
...
<a href="https://poojakira.github.io/ai-security-portfolio/"><img src="https://img.shields.io/badge/Explore_the_interactive_portfolio-4FD1C5?style=for-the-badge&logoColor=black" /></a>
...
<img src="https://komarev.com/ghpvc/?username=poojakira&style=flat-square&color=4FD1C5" alt="Profile views" />
