...
| :--- | :--- | :--- |
| **[mcp-agent-security-gateway](https://github.com/poojakira/mcp-agent-security-gateway)** | Inspects and gates MCP tool calls at the agent-to-tool boundary — inline stdio proxy, prompt-injection &amp; exfiltration checks, hash-chained audit log. | Prototype; controls only traffic routed through it. |
...
| :--- | :--- | :--- |
| [llm-redteam-framework](https://github.com/poojakira/llm-redteam-framework) | Prompt-injection detection with grouped / out-of-distribution evaluation. | Research baseline; F1 ≈ 0.70 OOD. |
